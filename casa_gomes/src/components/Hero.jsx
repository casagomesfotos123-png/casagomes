...
bem-estar</span></h1>
    ...
    <div data-aos="fade" data-aos-delay='850' className="btns-hero flex flex-row flex-wrap justify-center items-center gap-10 mt-2">
          ...
          <a href="https://wa.me/5511996568665" className="flex flex-row justify-center items-center transition-all duration-150 ease-in bg-[#16A34A] hover:bg-[#0e7233] hover:scale-[1.1] px-[10px] py-[8px] rounded-[7px] "><img src="WhatsApp.png" alt="whatsApp" className="w-[35px]"/><p className="text-[1em] font-medium">Falar no whatsApp</p></a>
    </div>
    </section>
  </>
  )
